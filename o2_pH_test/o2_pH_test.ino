...
const int O2Pin = 0;           // analog 0 
const int pHPin = 1;             // analog 1
...
void setup(void)
{
  ...
  logfile.println("millis,stamp,datetime,O2,pH");    
#if ECHO_TO_SERIAL
  Serial.println("millis,stamp,datetime,O2,pH");
#endif //ECHO_TO_SERIAL
...
void loop(void)
{
  ...
  //delay(10); 
  int O2Reading = analogRead(O2Pin);
  float O2 = O2Reading * (5.0 / 1023);  
